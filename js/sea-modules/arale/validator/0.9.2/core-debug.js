...
define("arale/validator/0.9.2/utils-debug", [ "./rule-debug", "./async-debug", "$-debug", "arale/widget/1.0.2/widget-debug", "arale/base/1.0.1/base-debug", "arale/class/1.0.0/class-debug", "arale/events/1.0.0/events-debug" ], function(require, exports, module) {
...
define("arale/validator/0.9.2/rule-debug", [ "./async-debug", "$-debug", "arale/widget/1.0.2/widget-debug", "arale/base/1.0.1/base-debug", "arale/class/1.0.0/class-debug", "arale/events/1.0.0/events-debug" ], function(require, exports, module) {
    var rules = {}, messages = {}, $ = require("$-debug"), async = require("./async-debug"), Widget = require("arale/widget/1.0.2/widget-debug");
...
define("arale/validator/0.9.2/item-debug", [ "./utils-debug", "./rule-debug", "./async-debug", "$-debug", "arale/widget/1.0.2/widget-debug", "arale/base/1.0.1/base-debug", "arale/class/1.0.0/class-debug", "arale/events/1.0.0/events-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), utils = require("./utils-debug"), Widget = require("arale/widget/1.0.2/widget-debug"), async = require("./async-debug"), Rule = require("./rule-debug");
    var setterConfig = {
        value: function() {},
        setter: function(val) {
...
define("arale/validator/0.9.2/core-debug", [ "./async-debug", "./utils-debug", "./rule-debug", "./item-debug", "$-debug", "arale/widget/1.0.2/widget-debug", "arale/base/1.0.1/base-debug", "arale/class/1.0.0/class-debug", "arale/events/1.0.0/events-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), async = require("./async-debug"), Widget = require("arale/widget/1.0.2/widget-debug"), utils = require("./utils-debug"), Item = require("./item-debug");
    var validators = [];
    var setterConfig = {
        value: function() {},
        setter: function(val) {
