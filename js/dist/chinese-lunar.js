...
(function(win) {
	...
	_chineseLunar.solarToLunar = function(solar, format) {
        console.log("the longli solar is " +solar.getFullYear());
		...
		//判断是否要格式化结果
        result={
            gongli:solar.getFullYear()+"年"+(parseInt(solar.getMonth())+1)+"月"+solar.getDate()+"日",
            nongli:"农历:"+monName[result.month]+"月"+dayName[parseInt(result.day)-1]+" "+weekName[solar.getDay()]
        }
    ...
    win.chineseLunar = _chineseLunar;
})(window);